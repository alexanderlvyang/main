...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=alipayPay method=post
			target="_blank">
		...
		<form name=tradequery action=alipayQuery method=post
			target="_blank">
		...
		<form name=traderefund action=alipay.trade.refundpage method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=alipay.trade.fastpay.refund.querypage method=post
			target="_blank">
		...
		<form name=tradeclose action=alipay.trade.closepage method=post
			target="_blank">
