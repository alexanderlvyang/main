...
<script type="text/javascript">
	$(function(){
		...
		$("#confirm").click(function(){
			var specification_id=$("#specificationId").val();
			...
			var productId=$("#specificationId").attr("productId");
			var price=$("#price").val();
			...
			if(price==""||product_color==""||product_specification==""){
				alert("不能有空");				
			}else{
				if($("#thumbnail").attr("src")==""){
						alert("请选择图片");
							...
							$.ajax({
								type:"post",
								url:"updateProductionSpecification.do",
								data:{
								...
								success:function(data){
									alert(data);
									if(data=="更新成功"){
										window.location="showSpecification.do?product_id="+productId;
									}
								},
								error:function(){
...
<body>
	<div class="tableDiv">
		<table>
			<tr>
				<td>编号：</td>
				<td><input type="text" id="specificationId" value="${specification.specification_id }" readonly="readonly" productId="${specification.product_id }"></td>
			</tr>
			<tr>
				<td>颜色：</td>
				<td><input type="text" id="productColor" value="${specification.product_color }"></td>
			</tr>
			<tr>
				<td>规格：</td>
				<td><input type="text" id="productSpecification" value="${specification.product_specification }"></td>
			</tr>
			<tr>
				<td>缩略图：</td>
				<td>
					...
					<img src="files/${specification.product_thumbnail }" alt="请选择图片" id="thumbnail">
				</td>
			</tr>
			<tr>
				<td>价格：</td>
				<td><input type="text" id="price" value="${specification.price}"></td>
			</tr>	
		</table>		
	</div>
	<div>
