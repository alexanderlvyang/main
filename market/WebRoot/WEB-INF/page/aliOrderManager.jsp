...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=aliPayPage.do method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=alipay.trade.fastpay.refund.query.do method=post
			target="_blank">
		...
		<form name=tradeclose action=alipay.trade.close.do method=post
			target="_blank">
