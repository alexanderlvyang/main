...
<head>
	...
	<script type="text/javascript">
		...
		function changeaccountlogin(id){
			$("#"+id).css("color","red");
	...
	<div class="login">
		...
		<div class="logindiv">
				<div class="loginchange">
					<a href="javascript:void(0)" id="scanlogin" onclick="changescanlogin(id)">扫码登陆</a>
					<a href="javascript:void(0)" id="accountlogin" onclick="changeaccountlogin(id)">账号登陆</a>
				</div>
				...
				<div class="accountlogindiv">
					...
					<input type="submit" value="登陆" class="loginbtn" onclick="formsubmit()">
					</form>
